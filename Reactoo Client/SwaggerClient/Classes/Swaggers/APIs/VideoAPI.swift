...
open class VideoAPI {
  ...
  "isFeatured" : false
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVideos(type: ModelType_getVideos, userId: String? = nil, fulltextPhrase: String? = nil, videoId: UUID? = nil, startKey: Data? = nil, withPublicReactions: WithPublicReactions_getVideos? = nil, excludeUserId: String? = nil, hashtag: String? = nil, includeUserModels: IncludeUserModels_getVideos? = nil, excludeVideoId: UUID? = nil, size: Int? = nil, completion: @escaping ((_ data: VideoList?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getVideosWithRequestBuilder(type: ModelType_getVideos, userId: String? = nil, fulltextPhrase: String? = nil, videoId: UUID? = nil, startKey: Data? = nil, withPublicReactions: WithPublicReactions_getVideos? = nil, excludeUserId: String? = nil, hashtag: String? = nil, includeUserModels: IncludeUserModels_getVideos? = nil, excludeVideoId: UUID? = nil, size: Int? = nil) -> RequestBuilder<VideoList> {
        let path = "/video/list"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
