...
open class AuthAPI {
     ...
     */
    open class func changePassword(requestAuthChangePassword: RequestAuthChangePassword, completion: @escaping ((_ data: ResponseEmpty?,_ error: Error?) -> Void)) {
     ...
     */
    open class func changePasswordWithRequestBuilder(requestAuthChangePassword: RequestAuthChangePassword) -> RequestBuilder<ResponseEmpty> {
  ...
  "codeDeliveryMedium" : "NONE"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func testCredentials(completion: @escaping ((_ data: ResponseEmpty?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<ResponseEmpty> 
     */
    open class func testCredentialsWithRequestBuilder() -> RequestBuilder<ResponseEmpty> {
