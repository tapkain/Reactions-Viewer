...
open class Reaction: Codable {
    ...
    public var originalVideoId: String?
    ...
    public init(id: String?, userId: String?, originalVideoId: String?, originalVideoUserId: String?, title: String?, isDeleted: Bool?, isPrivate: Bool?, isUserPublic: Bool?, isFeatured: Bool?, publishingTime: Int64?, featuredTime: Int64?, duration: Double?, recordVolume: Double?, likesCount: Int64?, commentsCount: Int64?, likesCounts: ReactionLikesCounts?, thumbnailFiles: [MediaFile]?, videoFiles: [MediaFile]?, hashtags: [String]?, adType: AdType?, orientation: Int?, timeline: [TimelineEvent]?) {
        self.id = id
        self.userId = userId
    ...
    public required init(from decoder: Decoder) throws {
        ...
        originalVideoId = try container.decodeIfPresent(String.self, forKey: "originalVideoId")
