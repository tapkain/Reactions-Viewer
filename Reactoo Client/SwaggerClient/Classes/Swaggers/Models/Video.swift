...
open class Video: Codable {
    ...
    public var id: IdReadOnly?
    public var userId: UserIdReadOnly?
    ...
    public init(id: IdReadOnly?, userId: UserIdReadOnly?, title: String?, description: String?, isDeleted: Bool?, isPrivate: Bool?, isUserPublic: Bool?, isFeatured: Bool?, publishingTime: Int64?, featuredTime: Int64?, duration: Double?, aspectRatio: Double?, reactionsCount: Int?, publicReactionsCount: Int?, thumbnailFiles: [MediaFile]?, videoFiles: [MediaFile]?, hashtags: [String]?, adType: AdType?, trendinessScore: Double?) {
        self.id = id
        self.userId = userId
        self.title = title
    ...
    public required init(from decoder: Decoder) throws {
        ...
        id = try container.decodeIfPresent(IdReadOnly.self, forKey: "_id")
        userId = try container.decodeIfPresent(UserIdReadOnly.self, forKey: "userId")
