...
open class ReactionLike: Codable {
    ...
    public init(id: MongoObjectId?, userId: UserId?, reactionId: Id, reactionUserId: UserId?, likeTime: Int64?, timeOffset: Double?, type: ModelType) {
        self.id = id
        self.userId = userId
    ...
    public required init(from decoder: Decoder) throws {
        ...
        id = try container.decodeIfPresent(MongoObjectId.self, forKey: "_id")
