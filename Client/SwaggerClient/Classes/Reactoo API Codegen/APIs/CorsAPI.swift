...
open class CorsAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func swaggerJsonOptions(completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
     ...
     */
    open class func swaggerJsonOptionsWithRequestBuilder() -> RequestBuilder<String> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func swaggerYmlOptions(completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<String> 
     */
    open class func swaggerYmlOptionsWithRequestBuilder() -> RequestBuilder<String> {
