...
open class ReactionAPI {
  ...
  "userId" : "userId",
  "originalVideoUserId" : "originalVideoUserId",
  ...
  "publishingTime" : 0,
  "commentsCount" : 0,
  "originalVideoId" : "046b6c7f-0b8a-43b9-b35d-6489e6daee91",
  "timeline" : [ {
  ...
  "isDeleted" : false,
  "reactionId" : "046b6c7f-0b8a-43b9-b35d-6489e6daee91",
  ...
  "commentTime" : 0
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getReactionComments(type: ModelType_getReactionComments, reactionId: String? = nil, includeUserModels: IncludeUserModels_getReactionComments? = nil, startKey: String? = nil, size: Int? = nil, completion: @escaping ((_ data: ReactionCommentList?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getReactionCommentsWithRequestBuilder(type: ModelType_getReactionComments, reactionId: String? = nil, includeUserModels: IncludeUserModels_getReactionComments? = nil, startKey: String? = nil, size: Int? = nil) -> RequestBuilder<ReactionCommentList> {
  ...
  "likeTime" : 0
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getReactionLikes(type: ModelType_getReactionLikes, reactionId: String? = nil, includeUserModels: IncludeUserModels_getReactionLikes? = nil, startKey: String? = nil, size: Int? = nil, completion: @escaping ((_ data: ReactionLikeList?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getReactionLikesWithRequestBuilder(type: ModelType_getReactionLikes, reactionId: String? = nil, includeUserModels: IncludeUserModels_getReactionLikes? = nil, startKey: String? = nil, size: Int? = nil) -> RequestBuilder<ReactionLikeList> {
     ...
     */
    open class func getReactionsWithRequestBuilder(type: ModelType_getReactions, excludeReactionId: UUID? = nil, userId: String? = nil, sort: Sort_getReactions? = nil, videoId: UUID? = nil, startKey: String? = nil, hashtag: String? = nil, includeUserModels: IncludeUserModels_getReactions? = nil, size: Int? = nil) -> RequestBuilder<ReactionList> {
