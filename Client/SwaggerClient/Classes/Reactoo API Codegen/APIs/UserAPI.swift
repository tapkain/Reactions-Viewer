...
open class UserAPI {
  ...
  "followingsCount" : 0
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUsers(type: ModelType_getUsers, userId: String? = nil, ids: String? = nil, startKey: String? = nil, size: Int? = nil, completion: @escaping ((_ data: UserList?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getUsersWithRequestBuilder(type: ModelType_getUsers, userId: String? = nil, ids: String? = nil, startKey: String? = nil, size: Int? = nil) -> RequestBuilder<UserList> {
        let path = "/user/list"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
